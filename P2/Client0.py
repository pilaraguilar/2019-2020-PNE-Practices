...
class Client:
    def __init__(self, ip, port):#function for initializing the object #strsbases: is a parameter, you can call wherever you want
        self.ip=ip # passed as an argument when creating the object
        self.port=port

    def ping(self): #theis function only prints ok
        print("OK")

    def __str__(self): #it ives the internal info of the object
