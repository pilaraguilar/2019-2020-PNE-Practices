...
seq1 = "ATTCCCGGGG" #you have to create a function that help you to know when a sequence is wrong

seq_check(seq1)


print(f"Seq:    {seq1}")
print(f"  Rev : {seq_reverse(seq1)}") #the reverse sequence as a parameter
